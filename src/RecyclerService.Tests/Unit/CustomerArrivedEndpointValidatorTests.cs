...
public class CustomerArrivedEndpointValidatorTests
{
    ...
    {
        var request = new CustomerArrivedEndpoint.Request { Bottles = 10 };
    ...
    {
        var request = new CustomerArrivedEndpoint.Request { Glass = 5 };
    ...
    {
        var request = new CustomerArrivedEndpoint.Request { Metal = 8 };
    ...
    {
        var request = new CustomerArrivedEndpoint.Request { Plastic = 12 };
    ...
    {
        var request = new CustomerArrivedEndpoint.Request
        {
    ...
    {
        var request = new CustomerArrivedEndpoint.Request { Bottles = 0 };
    ...
    {
        var request = new CustomerArrivedEndpoint.Request { Bottles = -5 };
