...
public interface IRecyclingPlantService
{
    ...
    Task<Guid> ProcessDeliveryAsync(Guid truckId, string truckName, Guid playerId, IDictionary<string, int> loadByType, decimal operatingCost, DateTimeOffset deliveredAt);
