...
public class TestcontainersFixture : IAsyncLifetime
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        var inMemory = new Dictionary<string, string?>
        {
            ...
            ["ConnectionStrings:RecyclingPlantConnection"] = ConnectionString
        };
        ...
        builder.Services.AddDbContext<RecyclingPlantDbContext>(options => options.UseNpgsql(builder.Configuration.GetConnectionString("RecyclingPlantConnection")));

        builder.Services.AddScoped<IRecyclingPlantService, Services.RecyclingPlantService>();
